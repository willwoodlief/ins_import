...
require_once 'JsonHelperHelper.php';
...
class  ErrorLogger {
	...
	public static function get_call_info()
	{
		...
		$gitinfo = ErrorLogger::getGitInfo();
		$ret['branch'] = $gitinfo['branch'];
		$ret['last_commit_hash'] = $gitinfo['commit'];
	...
	/**
	 * @return array ['branch'(string),'commit'(string),'dirty'(boolean) ]
	 */
	public static function getGitInfo() {
		...
		try {
			/** @noinspection PhpUnhandledExceptionInspection */  //phpstorm has a bug here
			$branch = $a->getCurrentBranchName();
		} catch(\Exception $e)  {
			$branch =  null;
		}
		...
		return ['branch'=>$branch,'commit'=>$commit,'dirty'=>$b_dirty];
	}
